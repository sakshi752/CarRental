...
const InfoSection = () => {
  return (
    <section className='mt-[16%] sm:mt-[10%] md:mt-[6.7%] w-[93%] lg:w-[80%] mx-auto flex flex-col items-center justify-center gap-1'>
      <p className='text-xl font-semibold'>Plan your trip now</p>
      <h1 className='text-2xl font-bold text-blue-950'>Quick and easy car rental</h1>
      <div className='grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-14 mt-[3%]'>
        <div className='flex flex-col items-center gap-4'>
          <IoCarSportOutline size={45} className='text-blue-950' />
        ...
        <div className='flex flex-col items-center gap-4'>
          <IoIosContacts size={45} className='text-blue-950' />
          <div className='flex flex-col items-center gap-2'>
        ...
        <div className='flex flex-col items-center gap-4'>
          <TbCarSuv size={45} className='text-blue-950' />
